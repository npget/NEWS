...
left: 16px;font-size:11px;'>Le informazioni sono trasmesse tramite rete pubblica e le anteprime delle attività sociali possono variare rispetto alle tipologie . </em>
...
//<script>$('#start').show();$("#start .loader").click(function(){$("#start").hide();})</script>
 ...
 return $pageURL;
	...
	<form method='post'>
	<input type='text' name='urlrss' value='<?=$_POST['urlrss'];?>'>
...
if($_POST['urlrss']!=""){$filenamepost=$_POST['urlrss'];}
